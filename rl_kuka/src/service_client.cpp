...
int main(int argc, char **argv) {
	...
	cout << "Service output: " << srv.response.pose.position.x << endl;
	cout << "Service output: " << srv.response.pose.position.y << endl;
	cout << "Service output: " << srv.response.pose.position.z << endl;
	cout << "Service output: " << srv.response.pose.orientation.x << endl;
	cout << "Service output: " << srv.response.pose.orientation.y << endl;
	cout << "Service output: " << srv.response.pose.orientation.z << endl;
	cout << "Service output: " << srv.response.pose.orientation.w << endl;
